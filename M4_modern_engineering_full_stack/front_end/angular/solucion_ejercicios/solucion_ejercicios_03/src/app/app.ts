...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Ejercicio01, Ejercicio02, Ejercicio03, Ejercicio04, Ejercicio05, Ejercicio06,Ejercicio07],
  templateUrl: './app.html',
  styleUrl: './app.css'
})
export class App {
  protected readonly title = signal('solucion_ejercicios_03');
}
