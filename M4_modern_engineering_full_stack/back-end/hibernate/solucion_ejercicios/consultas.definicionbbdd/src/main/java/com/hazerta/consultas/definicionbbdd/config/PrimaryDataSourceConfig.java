...
@EnableJpaRepositories(
        basePackages = "com.hazerta.consultas.definicionbbdd.primary.entity",
...
public class PrimaryDataSourceConfig {
    ...
    public DataSource primaryDataSource() {
        ...
        return DataSourceBuilder
                ...
                .url("jdbc:postgresql://localhost:5433/definicion_bbdd")
                .username("postgres")
                .password("postgres")
                .build();
    }
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(@Qualifier("primaryDataSource") DataSource dataSource) {
        ...
        em.setPackagesToScan("com.hazerta.consultas.definicionbbdd.primary.entity");
